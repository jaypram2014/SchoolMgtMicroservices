...
public class ClassController {
	...
	public ClassDTO saveclassData(@RequestBody ClassDTO classData) {
	...
	/*
	 * @PutMapping("/class/{id}") //@ResponseStatus(value = HttpStatus.CREATED)
	 * public ResponseEntity<ClassMaster> updateclassData(@RequestBody ClassMaster
	 * classData, @PathVariable Long id) {
	 * 
	 * // ClassMaster cls=null;
	 * 
	 * // pipeline processing / waterflow return
	 * Optional.ofNullable(classService.updateClassData(classData,
	 * id)).map(ResponseEntity::ok) .orElse(ResponseEntity.badRequest().build());
	 * 
	 * 
	 * 
	 * //// return cls;
